...
class JsonPreference {
  ...
  get lastSaveTime => _lastSaveTime;
  ...
  Future<void> load() async {
    ...
    lazy.log('$runtimeType.load():${jsonString.length}(byte)', forced: debugLogSave);
    Map<String, dynamic> json = jsonDecode(jsonString);
    lazy.log('$runtimeType.load():json decoded', forced: debugLogSave);
  ...
  /// Load and set _saveTime from local store
